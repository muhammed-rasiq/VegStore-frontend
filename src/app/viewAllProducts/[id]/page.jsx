        ...
        <div className="max-w-7xl mx-auto px-6 py-14">
          ...
          <div className="max-w-3xl">
            ...
            <p className="text-gray-600 leading-relaxed mt-5">
              Our fresh produce is sourced from trusted farmers
              and selected carefully to maintain quality and freshness.
              Store it properly and enjoy fresh ingredients for your
              everyday meals.
            </p>
